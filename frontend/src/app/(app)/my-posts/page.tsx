        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {ideas.map((idea) => (
            <ProtectedViewer key={idea.id}>
              <div className="bg-[#121221] border border-white/5 rounded-2xl overflow-hidden shadow-xl shadow-black/40 flex flex-col group hover:border-purple-500/30 transition-colors h-full">
                {/* Media Header */}
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-auto pt-4 border-t border-white/5">
                  {idea.tags && (typeof idea.tags === 'string' ? idea.tags.split(',') : idea.tags).slice(0, 3).map((tag: string) => (
